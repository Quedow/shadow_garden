...
abstract class Functions {
  ...
  static void onLongPress(AudioProvider audioProvider, AudioPlayer audioPlayer, BuildContext context, int index) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text(Texts.textNextSongSnack), backgroundColor: ThemeColors.otherColor, behavior: SnackBarBehavior.floating, duration: const Duration(seconds: 2)),
    );
  }
