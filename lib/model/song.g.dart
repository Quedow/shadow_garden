...
void _songSerialize(
  ...
  writer.writeDouble(offsets[1], object.listeningRate);
...
extension SongQueryFilter on QueryBuilder<Song, Song, QFilterCondition> {
  ...
  QueryBuilder<Song, Song, QAfterFilterCondition> nbOfListensEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'nbOfListens',
        value: value,
      ));
    });
  }

  QueryBuilder<Song, Song, QAfterFilterCondition> nbOfListensGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Song, Song, QAfterFilterCondition> nbOfListensLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Song, Song, QAfterFilterCondition> nbOfListensBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Song, Song, QAfterFilterCondition> scoreEqualTo(
    double value, {
    double epsilon = Query.epsilon,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Song, Song, QAfterFilterCondition> scoreGreaterThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Song, Song, QAfterFilterCondition> scoreLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Song, Song, QAfterFilterCondition> scoreBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension SongQuerySortBy on QueryBuilder<Song, Song, QSortBy> {
  ...
  QueryBuilder<Song, Song, QAfterSortBy> sortByNbOfListens() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'nbOfListens', Sort.asc);
    });
  }

  QueryBuilder<Song, Song, QAfterSortBy> sortByNbOfListensDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'nbOfListens', Sort.desc);
    });
  }

  QueryBuilder<Song, Song, QAfterSortBy> sortByScore() {
    return QueryBuilder.apply(this, (query) {
...
extension SongQuerySortThenBy on QueryBuilder<Song, Song, QSortThenBy> {
  ...
  QueryBuilder<Song, Song, QAfterSortBy> thenByNbOfListens() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'nbOfListens', Sort.asc);
    });
  }

  QueryBuilder<Song, Song, QAfterSortBy> thenByNbOfListensDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'nbOfListens', Sort.desc);
    });
  }

  QueryBuilder<Song, Song, QAfterSortBy> thenByScore() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'score', Sort.asc);
    });
  }

  QueryBuilder<Song, Song, QAfterSortBy> thenByScoreDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'score', Sort.desc);
    });
  }
...
extension SongQueryWhereDistinct on QueryBuilder<Song, Song, QDistinct> {
  ...
  QueryBuilder<Song, Song, QDistinct> distinctByNbOfListens() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'nbOfListens');
    });
  }
...
extension SongQueryProperty on QueryBuilder<Song, Song, QQueryProperty> {
  ...
  QueryBuilder<Song, int, QQueryOperations> nbOfListensProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'nbOfListens');
    });
  }
